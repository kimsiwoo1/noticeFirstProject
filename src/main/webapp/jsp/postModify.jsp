			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
					...
					<div class="col-sm-8 blog-main">
						<div class="blog-post">
						<form id="frm" action="${cp }/postModifyAction" method="post" enctype="multipart/form-data">
							<input type="hidden" id="boardNo" name="boardNo" value="${params.boardNo }">
							...
							<textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;">${params.postContents }</textarea>
